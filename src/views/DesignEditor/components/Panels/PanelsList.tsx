...
const PanelsList = () => {
  ...
  // PANEL_ITEMS is a constant that contains the list of panels
  // that will be displayed in the sidebar. chenck if editorType is VIDEO and return VIDEO_PANEL_ITEMS else return BASE_ITEMS
  ...
  return (
    <Block
      ...
      $style={{
        width: "80px",
        height: "80px",
        // backgroundColor: name === activePanel ? "green" : "cyan",
